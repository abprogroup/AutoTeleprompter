...
extension _ContentCreatorFeed on _ContentCreatorScreenState {
                    ...
                    gradient: RadialGradient(
                      ...
                      colors: [
                        ...
                        Colors.black.withValues(
                            alpha: (vignette * 1.1).clamp(0.0, 1.0)),
                        Colors.black.withValues(
                            alpha: (vignette * 2.0).clamp(0.0, 1.0)),
                      ],
  ...
  void _smoothScrollTick(Timer timer) {
    ...
    // Gentle glide: soft lerp capped per frame so word advances ease in
    // instead of snapping the script down.
    var step = diff * 0.035;
