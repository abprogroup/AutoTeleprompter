...
/// Ported from Windows' `script_gallery_screen.deleted_scripts.dart`. Cloud
/// Deleted Scripts cleanup messaging is dropped (Android has no cloud
/// feature yet - `android_parity_gaps.md` #5); every other behavior -
/// 30-day local recovery, select/restore/delete-forever - matches Windows.
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 38,
            decoration: BoxDecoration(
              color: const Color(0xFFFFBF00).withOpacity(0.12),
