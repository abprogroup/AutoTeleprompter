...
extension _ScriptEditorBuildParts on _ScriptEditorScreenState {
        ...
        children: [
          Scaffold(
            ...
            body: MouseRegion(
              ...
              child: Listener(
                onPointerDown: (event) {
                  if (_isPointInsideSelectionPreservingChrome(event.position)) {
                    return;
                  }
                  ...
                  child: Stack(
                    children: [
                              ...
                              Listener(
                                ...
                                child: FormattingToolbarMVP(
                                  ...
                                  onLayoutInteraction: (section) {
                                    _recordSuiteHistoryChange(section);
                                  },
                                ),
                              ),
                              Expanded(
                      ...
                      if (settings.debugMode)
                        Positioned(
                            bottom: 24, left: 24, child: _buildDebugSentry()),
                    ],
                  ),
                ),
              ),
  ...
  Widget _withEditorHistoryShortcuts(Widget child) {
    return Shortcuts(
      shortcuts: const {
