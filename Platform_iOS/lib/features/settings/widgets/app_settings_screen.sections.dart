...
extension _SettingsSections on _AppSettingsScreenState {
  List<Widget> _buildGeneralTab() {
    ...
    return [
      ...
      // STT/Speech settings live in Present mode (the prompter settings sheet)
      // and Media/Recording settings live in the Content Creator/Recorder
      // settings sheet — they are intentionally not duplicated in General.
    ];
  }
