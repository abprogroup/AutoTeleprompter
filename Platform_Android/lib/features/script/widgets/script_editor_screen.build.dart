...
extension _ScriptEditorScreenBuildParts on _ScriptEditorScreenState {
  Widget _buildBottomActions({bool keyboardVisible = false}) {
    ...
    Widget premiumAction({
      ...
      return Tooltip(
        message:
            hasPremiumAccess ? featureName : '$featureName requires Pro access',
        child: SizedBox(
          width: 50,
          height: 42,
          child: OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: BorderSide(color: premiumForeground),
              minimumSize: const Size(50, 42),
              maximumSize: const Size(50, 42),
            ...
            child: Row(
              children: [
                ...
                premiumAction(
                  ...
                  enabledIcon: Icons.mic_none_rounded,
  ...
  Widget _buildScriptEditorScreen(BuildContext context) {
    // "Edit at current position" from present/creator modes: place the caret
    // at the requested block/offset once, then clear the request.
    ...
    return Stack(
      children: [
                    ...
                    Shortcuts(
                      ...
                      child: Actions(
                        actions: {
                          ...
                          _UndoIntent:
                              CallbackAction<_UndoIntent>(onInvoke: (_) {
                            _undo();
                            return null;
                          }),
                          _RedoIntent:
                              CallbackAction<_RedoIntent>(onInvoke: (_) {
                            _redo();
                            return null;
                          }),
                          _SearchIntent:
                        ...
                        child: Column(
                          children: [
                            Listener(
                              behavior: HitTestBehavior.translucent,
                              onPointerDown: (_) =>
                                  _beginEditorToolbarSelectionGuard(),
                              child: FormattingToolbarMVP(
                                onBold: _onBold,
                                ...
                                onClear: () {
                                  ...
                                  WidgetsBinding.instance
                                    ...
                                    if (c != null) {
                                      ...
                                      if (!hasAlign) {
                                        ref
                                                .read(cursorStyleProvider.notifier)
                                                .state =
                                            ref
                                ...
                                bookmarksEnabled: _watchEditorPremiumAccess(),
                              ...
                              child: Container(
                                ...
                                child: GlobalSelectionOverlay(
                                  ...
                                  onSelectionChanged: () => setState(() {
                                    _isGlobalSelection = _controllers
                                            .isNotEmpty &&
                                        _controllers
        ...
        if (_walkthroughSampleGuideVisible) _buildSampleWalkthroughOverlay(),
      ],
    );
  }
