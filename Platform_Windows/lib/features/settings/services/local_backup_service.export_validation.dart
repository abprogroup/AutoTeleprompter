...
void _validatePdfExport(ScriptBackupExport export) {
  final prefix = ascii.decode(
    export.bytes.take(5).toList(),
    allowInvalid: true,
  );
  if (prefix != '%PDF-') {
    throw StateError('PDF export did not produce a valid PDF header.');
  }
}
