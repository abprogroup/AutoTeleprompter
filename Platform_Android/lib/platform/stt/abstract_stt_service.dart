...
///
/// Android note: start() returns Future<void> (Android's SpeechService
/// does not use SpeechStartResult). The result of starting is signalled
/// via onStatusChange / onError callbacks instead.
