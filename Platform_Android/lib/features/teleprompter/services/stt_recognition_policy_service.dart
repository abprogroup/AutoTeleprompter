...
/// Ported from Windows. `browserRecoveryReason` (embedded WebView2/browser-STT
/// heartbeat recovery) was NOT ported - Android's STT adapters are native
/// (speech_to_text package), never an embedded browser surface, so that
/// concept doesn't apply here. Everything else is a straight port.
