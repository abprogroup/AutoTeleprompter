...
- [P] **Color Picker Reopen**: Picker must show active color when reopened. (AI VERIFIED: Ring Indicator & Black Preset) - its the second time its failing! - you didnt add the black color to the color picker presets - and you still dont show the active colors for the highlighted and text colors.
- [U] **Toolbar "C" Button**: Move to main toolbar (left of TEXT) -> Clear all styles/colors/align. (AI VERIFIED: Hard Reset Logic)
- [P] **BUG: History Sorting**: Reverse history list order (latest at TOP). (AI VERIFIED)
