...
class _TeleprompterScreenState extends ConsumerState<TeleprompterScreen> {
      ...
      if (mounted) {
        showDialog(
          ...
          builder: (_) => AlertDialog(
            ...
            content: const Text(
              'AutoTeleprompt needs microphone access to follow your speech.\n\nGo to Settings → Privacy → Microphone and enable it.',
  ...
  Alignment _toAlignment(TextAlign? paraAlign, AppSettings settings) {
    final align = _toTextAlign(paraAlign, settings);
  ...
  WrapAlignment _toWrapAlignment(TextAlign? paraAlign, AppSettings settings) {
    final align = _toTextAlign(paraAlign, settings);
    if (align == TextAlign.center) return WrapAlignment.center;
    if (align == TextAlign.right) return WrapAlignment.end;
